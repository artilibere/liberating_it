...
- **Slug:** `1-2-4-all` | **Stato:** nel repo
- **Scopo:** Fai emergere idee da tutti in quattro passaggi: da solo, in coppia, in quattro, in plenaria. Nessuno resta fuori.
- **Durata:** 15 minuti | **Difficolta':** Facile | **Fase:** Ideate
- **Hub Per bisogno:** Generare idee
- **Quando usarla:**
...
- **Slug:** `15-solutions` | **Stato:** nel repo
- **Scopo:** Aiutare le persone a identificare e concentrarsi sulle azioni concrete che possono intraprendere subito, senza bisogno di ulteriori risorse o autorizzazioni.
- **Durata:** 20 minuti | **Difficolta':** Facile | **Fase:** Ideate
- **Hub Per bisogno:** Generare idee
- **Quando usarla:**
  - Risoluzione di problemi che richiedono il coinvolgimento di più persone.
...
- **Slug:** `25-10-crowd-sourcing` | **Stato:** nel repo
- **Scopo:** Raccogliere e valutare collettivamente idee innovative in soli 30 minuti.
- **Durata:** 30 minuti | **Difficolta':** Intermedia | **Fase:** Ideate
- **Hub Per bisogno:** Generare idee
- **Quando usarla:**
  - Raccogliere e valutare collettivamente idee innovative in soli 30 minuti.
...
- **Slug:** `4-2-1-storming` | **Stato:** adattamento locale
- **Scopo:** Facilitare una generazione di idee strutturata che parte dal gruppo per arrivare a intuizioni individuali profonde, utilizzando la scrittura silenziosa come strumento di riflessione.
- **Durata:** 10 minuti | **Difficolta':** Intermedia | **Fase:** Ideate
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
  - Per gestire costruttivamente le resistenze al cambiamento.
...
- **Slug:** `9-whys` | **Stato:** nel repo
- **Scopo:** Scoprire il vero scopo del lavoro del gruppo.
- **Durata:** 20 minuti | **Difficolta':** Facile | **Fase:** Define
- **Hub Per bisogno:** Analizzare problemi
- **Quando usarla:**
  - Scoprire il vero scopo del lavoro del gruppo.
...
- **Slug:** `appreciative-interviews-ai` | **Stato:** nel repo
- **Scopo:** Di Appreciative Interviews Questa struttura permette di scoprire e costruire sulle radici del successo attraverso la condivisione di storie positive.
- **Durata:** 60 minuti | **Difficolta':** Facile | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `celebrity-interview` | **Stato:** nel repo
- **Scopo:** Trasforma una presentazione frontale in una conversazione guidata con il gruppo.
- **Durata:** 45 minuti | **Difficolta':** Intermedia | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `conversation-cafe` | **Stato:** nel repo
- **Scopo:** Il Conversation Café è una struttura che permette di facilitare conversazioni profonde e costruttive, riducendo il dibattito e favorendo l’ascolto attivo attraverso un formato strutturato di dialogo.
- **Durata:** variabile | **Difficolta':** Intermedia | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `discovery-action-dialogue-dad` | **Stato:** nel repo
- **Scopo:** Di Discovery & Action Dialogue Il DAD permette a un gruppo di scoprire autonomamente pratiche e comportamenti che consentono ad alcuni individui di trovare soluzioni migliori ai problemi comuni, nonostante abbiano le stesse risorse e vincoli dei colleghi.
- **Durata:** variabile | **Difficolta':** Intermedia | **Fase:** Define
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
  - Scoprire soluzioni già esistenti ma non diffuse all’interno dell’organizzazione..
...
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
  - Rivelare intuizioni e comprensioni non accessibili con metodi verbali o lineari.
...
- **Slug:** `heard-seen-respected-hsr` | **Stato:** nel repo
- **Scopo:** Di Heard, Seen, Respected Sviluppare la capacità di ascolto empatico e creare un ambiente di maggiore comprensione reciproca tra i partecipanti.
- **Durata:** 35 minuti | **Difficolta':** Intermedia | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `helping-heuristics` | **Stato:** nel repo
- **Scopo:** Le Helping Heuristics sono un metodo progressivo per migliorare il modo in cui diamo e riceviamo aiuto nelle organizzazioni, sperimentando diversi pattern di interazione e offrendo preziosi spunti per sviluppare relazioni di aiuto più efficaci.
- **Durata:** 15 minuti | **Difficolta':** Intermedia | **Fase:** Test
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `impromptu-networking` | **Stato:** nel repo
- **Scopo:** Creare rapidamente connessioni significative tra i partecipanti e far emergere le sfide più rilevanti per il gruppo.
- **Durata:** 20 minuti | **Difficolta':** Facile | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `improv-prototyping` | **Stato:** nel repo
- **Scopo:** L’Improv Prototyping è un metodo che permette di sviluppare soluzioni efficaci a sfide croniche attraverso la drammatizzazione e il gioco strutturato.
- **Durata:** variabile | **Difficolta':** Intermedia | **Fase:** Prototype
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
  - Quando si devono affrontare sfide complesse o croniche.
...
- **Slug:** `liquid-courage` | **Stato:** adattamento locale
- **Scopo:** Liquid Courage è una variante dinamica di Impromptu Networking pensata per far emergere e processare le lamentele croniche in un ambiente sicuro e strutturato, trasformando la negatività in spunti di miglioramento.
- **Durata:** 15 minuti | **Difficolta':** Intermedia | **Fase:** Multi fase
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `mad-love` | **Stato:** adattamento locale
- **Scopo:** Mad Love è una variante potente e intima di Mad Tea, progettata per creare connessioni profonde tra i partecipanti attraverso domande personali.
- **Durata:** 45 minuti | **Difficolta':** Intermedia | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `mad-tea` | **Stato:** nel repo
- **Scopo:** Mad Tea è una microstruttura dinamica che attiva l’intelligenza collettiva attraverso un dialogo rapido e strutturato, stimolando riflessioni immediate e autentiche.
- **Durata:** 45 minuti | **Difficolta':** Intermedia | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Quando usarla:**
  - Definire gli elementi assolutamente necessari per il successo di un’iniziativa;.
...
- **Slug:** `open-space-technology-ost` | **Stato:** nel repo
- **Scopo:** Il gruppo si auto-organizza attorno a un tema, crea l'agenda e lavora in sessioni parallele. Tu tieni lo spazio, non dirigi i contenuti.
- **Durata:** variabile | **Difficolta':** Intermedia | **Fase:** Multi fase
- **Hub Per bisogno:** Fare strategia
- **Quando usarla:**
...
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
  - Aiutare gruppi numerosi a identificare ostacoli e opportunità per diffondere idee o innovazioni a più livelli.
...
- **Slug:** `pixies-reflection` | **Stato:** adattamento locale
- **Scopo:** Pixie Reflection è una variante maggiormente strutturata di 1-2-4-all , centrata su 4 domande guida, ispirate a Talking with Pixies e TRIZ , che consente di facilitare conversazioni profonde sugli obiettivi personale e le resistenze al cambiamento, esplorando ambizioni e paure.
...
- **Slug:** `shift-share` | **Stato:** nel repo
- **Scopo:** Shift & Share permette di condividere rapidamente ed efficacemente diverse innovazioni o programmi utili che potrebbero essere nascosti all’interno di un gruppo, un’organizzazione o una comunità.
- **Durata:** variabile | **Difficolta':** Intermedia | **Fase:** Prototype
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
  - Presentazione di nuove tecnologie o metodologie.
...
- **Slug:** `simple-ethnography` | **Stato:** nel repo
- **Scopo:** Permettere ai partecipanti di trovare soluzioni innovative immergendosi nelle attività delle persone con esperienza diretta sul campo, come colleghi in prima linea o utilizzatori dei servizi.
- **Durata:** variabile | **Difficolta':** Intermedia | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
  - Quando esistono differenze significative di performance tra team o individui.
...
- **Slug:** `talking-with-pixies` | **Stato:** nel repo
- **Scopo:** Portare alla luce le voci interiori contrastanti che influenzano il nostro percorso verso gli obiettivi, permettendo di riconoscere sia le resistenze che le spinte al cambiamento.
- **Durata:** 20 minuti | **Difficolta':** Intermedia | **Fase:** Ideate
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `tiny-demons` | **Stato:** adattamento locale
- **Scopo:** Tiny Demons è una Liberating Structure creativa che aiuta i partecipanti a esternare e trasformare le proprie paure in modo giocoso e costruttivo.
- **Durata:** 25 minuti | **Difficolta':** Facile | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `triz` | **Stato:** nel repo
- **Alias ufficiale:** Creative Destruction (liberatingstructures.com/creative-destruction)
- **Scopo:** Creare spazio per l’innovazione eliminando attività controproducenti.
- **Durata:** 35 minuti | **Difficolta':** Intermedia | **Fase:** Define
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `troika-consulting` | **Stato:** nel repo
- **Scopo:** Tre persone, tre ruoli: uno porta un problema, due consigliano ascoltando. Poi ruotate.
- **Durata:** 30 minuti | **Difficolta':** Facile | **Fase:** Test
- **Hub Per bisogno:** Generare idee
- **Quando usarla:**
...
- **Slug:** `user-experience-fishbowl` | **Stato:** nel repo
- **Scopo:** User Experience Fishbowl permette a un piccolo gruppo di persone con esperienza diretta sul campo di condividere le proprie conoscenze con una comunità più ampia, favorendo comprensione, creatività e adozione di nuove pratiche.
- **Durata:** variabile | **Difficolta':** Intermedia | **Fase:** Empathize
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Slug:** `w3-what-so-what-now-what` | **Stato:** nel repo
- **Scopo:** Di What, So What, Now What? Facilitare la consulenza tra pari per risolvere sfide concrete e ottenere nuove prospettive sui problemi.
- **Durata:** 30 minuti | **Difficolta':** Intermedia | **Fase:** Define
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
...
- **Hub Per bisogno:** Analizzare problemi
- **Quando usarla:**
  - Durante trasformazioni aziendali significative.
...
- **Slug:** `wise-crowds` | **Stato:** nel repo
- **Scopo:** Wise Crowds permette di attivare rapidamente l’intelligenza collettiva di un gruppo per aiutare i singoli partecipanti a risolvere sfide concrete.
- **Durata:** 20 minuti | **Difficolta':** Intermedia | **Fase:** Ideate
- **Hub Per bisogno:** Multi-bisogno
- **Quando usarla:**
