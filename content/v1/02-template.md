# Template contenuti - liberating.it

Modelli fissi per schede strutture e pagine editoriali. Ogni bozza in `content/` segue questi template e la skill [liberating-tone-of-voice](../../.cursor/skills/liberating-tone-of-voice/SKILL.md).
...
**File:** `content/strutture/{slug}.md`
...
- [ ] Tono di voce + scrittura naturale (skill)
