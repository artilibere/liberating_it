# Architettura informativa - liberating.it (v2)

Documento di riferimento per menu, navigazione, tassonomie e internal linking. Schede struttura in `content/v2/strutture/`.
